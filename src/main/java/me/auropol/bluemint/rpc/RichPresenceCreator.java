...
public class RichPresenceCreator {
    ...
    public void createSimpleRichPresence(long appID, String state, String details, String imageDesc, String imagePath)  {
        DiscordEventHandlers handlers = new DiscordEventHandlers();
        rpc.Discord_Initialize(String.valueOf(appID), handlers, true, "");
      ...
      public void createRichPresenceFromArrays(long appID, String[] states, String[] details, String[] imageDescriptions, String[] imagePaths, boolean constantlyUpdateAsGif, boolean updateImagesRandomly) {
